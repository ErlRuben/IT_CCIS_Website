...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="assets/css/delete_announcement.css" />
	...
	<body class="is-preload">
		...
		<section class="wrapper2">
			<header class="special">
				<h2 class = "hh">ARCHIVE ANNOUNCEMENTS</h2>
			<header>
		</section>
		</ul>
		<ul class = "ee">
		...
		<div class="btnn-group">
			<a id="mybutton" >
				<button class="button" value="DELETE ANNOUNCEMENTS" type="submit" ><span>Delete</span></button>
			</a>
		</div>

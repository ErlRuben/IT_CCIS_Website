	...
	<body class="is-preload">
            ...
            <section class="wrapper2">
                <header class="special">
                    <h2>RESTORE ARCHIVED ANNOUNCEMENTS</h2>
                <header>
            </section>
                     ...
                     if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            if (isset($_POST[$row['id']])){
                                $archiveID = $row['id'];
                                echo "<p>$archiveID restored.</p>";
                                $archivequery = "UPDATE announcement_tb SET stat='active' WHERE id='$archiveID'";
                        ...
                        echo 
                        "<h1> ANNOUNCEMENT HAS BEEN RESTORED </h1>
                        <form action='admin_announcements.php' method='POST'>
                        <p><input type='submit' value='OK'></p>
                        </form>";
                    }else{
                        echo 
                            "<h1> NOTHING TO RESTORE </h1>
                            <form action='admin_announcements.php' method='POST'>
                            <p><input type='submit' value='OK'></p>
                            </form>";
                     }     
